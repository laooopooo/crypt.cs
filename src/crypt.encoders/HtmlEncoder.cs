...
namespace Crypt.Encoders {
  ...
  public class HtmlEncoder: IStringEncoder {
    ...
    /// @var entities
    /// Mappings between the hexadecimal notations of a character and the corresponding HTML entities.
    private static readonly Dictionary<int, string> entities=new Dictionary<int, string> {
      { 160, "nbsp" },
      { 161, "iexcl" },
      { 162, "cent" },
      { 163, "pound" },
